 ...
 * {@link DropdownList} as the host's modal (so it floats above the popup body); choosing an item
 * writes the bound {@link Option} live and closes the list.
 */
